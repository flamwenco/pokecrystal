	...
	tilepal 1, GRAY, BROWN, BROWN, RED, GREEN, GREEN, GRAY, WATER
	tilepal 1, WATER, WATER, WATER, ROOF, ROOF, ROOF, ROOF, ROOF
	tilepal 1, ROOF, ROOF, ROOF, GREEN, WATER, GREEN, BROWN, WATER
	tilepal 1, WATER, WATER, WATER, BROWN, BROWN, GRAY, GREEN, GREEN
	...
	tilepal 1, WATER, WATER, WATER, WATER, WATER, ROOF, RED, ROOF
